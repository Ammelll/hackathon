...
function setup() {
    levels = [
        ...
        [new Rectangle(grassImage, width * 11 / 12, height / 2, width / 6), new Rectangle(grassImage, width * 6 / 5, height / 2, width / 3), new Spikes(width * 13/10, height / 2, 300, 10), new Rectangle(stoneImage, width * 8/5, height/2 - 100 , width/6, 20,200),new Rectangle(grassImage, width * 6 / 5, height / 8, width / 3),new Spikes(width * 13/10, height/8, 300, 10), new Rectangle(stoneImage, width, -100 , width/6, 20,200),new Rectangle(grassImage, width * 6 / 5, -height / 3, width / 2), new Spikes(width * 13/10, -height / 3, 300, 10),new Flag(width*8/5,-height / 3 -100)],
        [new Rectangle(grassImage, width * 11 / 12, height / 2, width / 6),new Rectangle(grassImage, width * 14 / 12, height / 2, width / 6), new Triangle(dirtImage, width * 29/24, height/2, width * 29/24,height/2 - height/12, width * 31/24, height/2), new Rectangle(grassImage, width * 33 /24, height / 2, width / 4), new Wrecking_Ball(stoneImage,width * 71/48, height /2 - height / 8, height / 8, 60)],
